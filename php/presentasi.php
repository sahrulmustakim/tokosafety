...
$email_message .= "Message submitted via Request Form (Presentasi) at onestopgps.co <br>";
...
$email_message .= "Tanggal dan Jam : ".stripslashes($tanggaljam)."<br><br>";
...
mail($email_it_to,'Request Form (Presentasi)',$email_message,$headers);
